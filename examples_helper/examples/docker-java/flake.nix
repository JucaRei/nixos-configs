    ...
    let
      ...
      sourcePerArch = {
        ...
        x86_64 = {
          ...
          # JDK (alpine)
          url =
            "https://github.com/adoptium/temurin17-binaries/releases/download/jdk-17.0.4.1%2B1/OpenJDK17U-jdk_x64_alpine-linux_hotspot_17.0.4.1_1.tar.gz";
          sha256 =
            "1a1706304c26da0d8d2e05127c5aa7dba00e5401b2c0228c8ae894d2812beee0";
        };
      };
