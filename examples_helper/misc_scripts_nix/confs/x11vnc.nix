  ...
  config = lib.mkIf config.services.xserver.enable {
    ...
    systemd.services."x11vnc" = {
      ...
      serviceConfig = {
        ...
        ExecStart =
          "${pkgs.x11vnc}/bin/x11vnc -passwdfile /home/${user}/passwd -noxdamage -nap -many -repeat -clear_keys -capslock -xkb -forever -loop100 -auth /var/run/lightdm/root/:0 -display :0 -clip 1920x1080+1920+0";
