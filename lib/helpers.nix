...
in {
  ...
  mkHome = { hostname, username, desktop ? null, platform ? builtins.listToAttrs (builtins.map(s: { name = s; value = { packages = systems;}; }) systems) }: inputs.home-manager.lib.homeManagerConfiguration {
